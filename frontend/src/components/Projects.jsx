...
export const Projects = () => {
  return (
    <div id='projects'>
      <div className='flex xl:grid xl:grid-cols-4 overflow-x-auto no-scrollbar'>
        <div className="min-w-[400px] xl:w-[400px] xl:min-w-0">
        ...
        <div className="min-w-[400px] xl:w-[400px]  xl:min-w-0">
          <Card image={project3} title="Food Website" t1="HTML" t2="CSS" t3="JavScript" description="A healthy meal delivered yo your door every singla day."/>
        </div>

        <div className="min-w-[400px] xl:w-[400px]  xl:min-w-0">
          <Card image={project4} title="Nature Website" t1="MongoDB" t2="Express" t3="React" t4="Nodejs" description="Chat like a family"/>
        </div>
      </div>
    </div>
  )
