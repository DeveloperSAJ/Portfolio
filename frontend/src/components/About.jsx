...
export const About = () => {
  return (
    <div id="about">
      <div className="flex">
        {/* Image */}
        <div className="my-10 mx-auto w-[30%] font-bold text-2xl font-mono text-white bg-gradient-to-r from-black to-gray-600 border-none rounded-xl shadow-box max-w-[350px] hidden xl:block">
          <img src={person} alt="person" className="" />
        </div>

        {/* Text Container */}
        <div className="my-10 p-10 mx-auto w-[95%] xl:w-[63%] font-bold  font-mono text-white bg-gradient-to-r from-black to-gray-600 border-none rounded-xl shadow-box">
