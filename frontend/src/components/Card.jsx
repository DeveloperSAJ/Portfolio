...
export const Card = ({ image, title, t1,t2,t3,t4 , description }) => {
  return (
    <div>
      <div className="flex flex-col my-5 mx-auto w-[95%] font-bold text-2xl font-mono text-white bg-gradient-to-r from-black to-gray-500 border-none rounded-xl shadow-box h-120">
        <div className="">
